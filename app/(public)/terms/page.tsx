    ...
    <div className={styles.page}>
      <main className={styles.sheet}>
        ...
        <ul className={styles.ul}>
          ...
          <li className={styles.li}>
            서비스 이용요금은 리포트 1부당 29,000원이며, 결제수단·금액은 신청 화면에 표시됩니다.{" "}
            <span className={styles.todo}>[확인 필요: 결제수단(토스/카카오페이 등) 연동 후 확정]</span>
          </li>
        </ul>

        <h2 className={styles.h2}>제7조 (청약철회 및 환불)</h2>
        <ul className={styles.ul}>
          <li className={styles.li}>
            이용자는 「전자상거래 등에서의 소비자보호에 관한 법률」에 따라 계약 내용을 확인할 수 있는
            서면(전자문서 포함)을 받은 날부터 7일 이내에 청약을 철회할 수 있습니다.
          </li>
          <li className={styles.li}>
            다만 본 서비스는 디지털 콘텐츠로서, <b>리포트 제작(콘텐츠 제공)이 개시된 경우 같은 법 제17조
            제2항에 따라 청약철회가 제한</b>될 수 있습니다. 회사는 이 경우 청약철회가 제한된다는 사실을
            사전에 표시합니다.
          </li>
          <li className={styles.li}>
            제작 착수 전이거나 회사의 귀책으로 리포트가 제공되지 못한 경우에는 전액 환불합니다.
          </li>
        </ul>
