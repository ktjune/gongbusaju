...
const REVIEWS: Review[] = [
  {
    text:
      "아이들뿐만 아니라 제 것도 해보았는데, 아이들이 어리다 보니 저를 토대로 한 내용을 보고 " +
      "신뢰가 갔습니다. 나도 어릴 때 이런 부분을 알았더라면 좀 더 발전적인 모습이 되지 " +
      "않았을까 하는 생각도 들고, 앞으로 아이들을 어떻게 교육하면 될지 방향이 잡히는 것 같았습니다.",
    author: "7세 남아·5세 여아 보호자 황OO님",
    disclosure: "리포트를 무료로 제공받아 작성한 후기입니다",
  },
  {
    text:
      "전에 공부와 관련된 점을 보았는데, 전반적인 내용이 정말 동일하게 나와서 놀랐습니다. " +
      "거기에 진학과 관련하여 어떤 방향을 가져야 하는지 감을 잡을 수 있어서 어느 정도 " +
      "도움이 된 것 같아요.",
    author: "10대 남아 보호자 엄OO님",
    disclosure: "리포트를 무료로 제공받아 작성한 후기입니다",
  },
];
