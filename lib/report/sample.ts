...
const perspectiveProvider: LlmProvider = {
  async complete() {
    return JSON.stringify({
      ...
      stageProse: prose([
        "예비 초등은 누구에게나 큰 전환이지만, 이 아이에게 특히 중요한 건 **'속도'**입니다. 금·수",
        "기운이 강해 새 환경을 눈으로 충분히 관찰한 뒤에야 마음을 여는 결이라, 낯선 곳에서 처음",
        "며칠 말이 없어지는 건 위축이 아니라 이 아이의 자연스러운 적응 방식으로 보아 주세요.",
        "재촉하지 않고 지켜봐 주시면 스스로 속도를 냅니다.\n\n",
        "다만 칠살의 긴장이 있어 '틀리면 어쩌지'가 앞서기 쉬운 점은 지금 미리 살펴 주면 좋습니다.",
        "글씨나 숫자를 틀렸을 때 고쳐 주기보다 시도 자체를 짚어 칭찬해 주시면, 입학 후 새 과제",
        "앞에서 움츠러들지 않는 힘이 생깁니다.\n\n",
        "반대로 인성이 발달해 '듣고 받아들이는 준비'는 이미 잘 되어 있는 아이입니다. 그래서 이",
        "아이에게는 선행 학습보다 읽어 주는 이야기의 폭을 넓혀 주는 편이 훨씬 큰 밑돌이 되는",
        "것으로 해석됩니다.",
      ]),
      eduStagesProse: prose([
        ...
        "틀을 몸에 익히도록 돕는 것이 이 아이의 분석 강점과 잘 맞습니다. 자유학기 활동은 조용히",
        "관찰·기록하는 역할부터 맡겨 자신감을 쌓게 해 주세요.\n\n",
